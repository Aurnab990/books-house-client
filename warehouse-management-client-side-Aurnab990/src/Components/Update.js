...
const Update = () => {
    ...
    const handleUpdateitems = event => {
        ...
        fetch(`https://aqueous-shore-07149.herokuapp.com/books/${id}`, {
            method: 'PUT', // or 'POST'
            headers: {
        ...
        <div>
            <div className="flex p-5 ml-44 mt-10 flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                ...
                <div className="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Price: {user.price}</p>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Stock: {user.inStock}</p>

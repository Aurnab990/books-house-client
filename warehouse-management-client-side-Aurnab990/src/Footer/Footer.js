                ...
                <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                    <div>
                        ...
                        <ul className="text-gray-300">
                            ...
                            <li className="mb-4">
                                <a href="/home" className="hover:underline hover:text-red-500">Careers</a>
                            </li>
                            <li className="mb-4">
                                <a href="/home" className="hover:underline hover:text-red-500">Book Center</a>
                            </li>
                            <li className="mb-4">
                                <a href="/blog" className="hover:underline hover:text-red-500">Blog</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-300">
                            <li className="mb-4">
                                <a href="/discord" className="hover:underline hover:text-red-500">Discord Server</a>
                            </li>
                            <li className="mb-4">
                                <a href="/twitter" className="hover:underline hover:text-red-500">Twitter</a>
                            </li>
                            
                            <li className="mb-4">
                                <a href="/home" className="hover:underline hover:text-red-500">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-300">
                            <li className="mb-4">
                                <a href="/home" className="hover:underline hover:text-red-500">Privacy Policy</a>
                            </li>
                            <li className="mb-4">
                                <a href="/home" className="hover:underline hover:text-red-500">Licensing</a>
                            </li>
                            <li className="mb-4">
                                <a href="/home" className="hover:underline hover:text-red-500">Terms &amp; Conditions</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-300">
                            <li className="mb-4">
                                <a href="/apple" className="hover:underline hover:text-red-500">iOS</a>
                            </li>
                            <li className="mb-4">
                                <a href="google" className="hover:underline hover:text-red-500">Android</a>
                            </li>
                            <li className="mb-4">
                                <a href="/microsoft" className="hover:underline hover:text-red-500">Windows</a>
                            </li>
                            <li className="mb-4">
                                <a href="/apple" className="hover:underline hover:text-red-500">MacOS</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com">Books House</a>. All Rights Reserved.
                    </span>
